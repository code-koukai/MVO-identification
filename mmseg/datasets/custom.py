...
class CustomDataset(Dataset):
    ...
    def get_palette_for_custom_classes(self, class_names, palette=None):
        ...
        if self.label_map is not Nxone:
    ...
    def evaluate(self,
        ...
        class_table_data = [['Class'] + [m[1:] for m in metric] + ['Recall']]
        if self.CLASSES is None:
        ...
        summary_table_data = [['Scope'] +
                              ['m' + head
                               for head in class_table_data[0][1:]] + ['aRecall']]
        ret_metrics_mean = [
...
class CustomDataset_cityscape_clips(Dataset):
    ...
    def prepare_train_img(self, idx):
        ...
        try:
            ...
            for ii in dilation_used:
                ...
                im_name_new = "_".join(
                    value_i_splits[:-2] + [(str(int(value_i_splits[-2]) + ii)).rjust(2,"0")] + value_i_splits[-1:])
                ...
                if not os.path.isfile(self.img_dir+'/'+im_name_new):
                    print("self.img_dir+'/'+im_name_new:",self.img_dir+'/'+im_name_new)
                    assert False
        except:
        ...
        for kkk in img_anns:
            ...
            # print(results['gt_semantic_seg'][100][100])
    ...
    def evaluate(self,
        ...
        message = f'TP: {ret_metrics[0]}\n, FP: {ret_metrics[1]}\n, FN: {ret_metrics[2]}\n, TN: {ret_metrics[3]}\n, specificity: {ret_metrics[4]}\n, recall: {ret_metrics[5]}\n, precision: {ret_metrics[6]}\n, accuracy: {ret_metrics[7]}\n, f1: {ret_metrics[8]}\n, auc: {ret_metrics[9]}\n'
        print_log(message, logger)
